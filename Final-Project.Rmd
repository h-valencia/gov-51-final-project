...
modelsummary(mods, coef_map = coef_names, stars = TRUE, title = "Length Incarcerated, Race, Age, Education Level, and Political Party on Political Issue Stances (from 0 to 1)")
```
...
legend("topleft", 
       ...
       col = c("violet", "violetred2", "blue", "blue4"),
       bty = "n", pch=20 , pt.cex = 2, cex = 0.7, horiz = FALSE, inset = c(0.01, 0.05))
...
legend("topleft", 
       ...
       col = c("violet", "violetred2", "blue", "blue4", "mediumpurple1", "purple3"),
       bty = "n", pch=20 , pt.cex = 2, cex = 0.55, horiz = FALSE, inset = c(0.125, 0.01))
...
legend("topleft", 
       ...
       col = c("violet", "violetred2", "blue", "blue4"),
       bty = "n", pch=20 , pt.cex = 2, cex = 0.65, horiz = FALSE, inset = c(0.03, 0.01))
...
legend("topleft", 
       ...
       col = c("violet", "violetred2", "blue", "blue4"),
       bty = "n", pch=20 , pt.cex = 2, cex = 0.7, horiz = FALSE, inset = c(0.05, 0.05))
...
legend("topleft",
       ...
       col = c("violet", "violetred2", "blue", "blue4", "mediumpurple1", "purple3", "cadetblue1", "dodgerblue2"),
       bty = "n", pch=20 , pt.cex = 1, cex = 0.5, horiz = FALSE, inset = c(0.008, 0.007))
